...
def record_data(driver):
    ...
    if element_time:
        ...
        xpath_value_dict = {
            ...
            # Define the header
            # team1 =//*[@id="538418728"]/div/div[1]/div/div[2]/div/div/div[2]/div[1]/div[2]/div 
            # team2 =//*[@id="538418728"]/div/div[1]/div/div[2]/div/div/div[2]/div[3]/div[2]/div
        ...
        # match = re.search(r'/live/fifa/(\d+)-', current_url)
        # match_no = match.group(1)
